...
export const NEWS_DATA = {
  "competitors": {
    ...
    "briefing": {
      "summary": "As of 2026-06-16, 7 article(s) from The Information, CNBC, Yahoo Finance, Reuters, Mobile World Live, Qualcomm Newsroom cover competitors: \"Qualcomm in Talks to Buy Tenstorrent to Expand AI Chip Capabilities\"; \"Qualcomm bets $14 billion on cracking NVIDIA AI monopoly with Modular acquisition\"; \"Qualcomm (QCOM) Is In Talks To Buy Modular For $4 Billion\"; \"Sources: Qualcomm in talks to design custom chips for ByteDance\"; \"Qualcomm teams with OpenAI and MediaTek on AI smartphone chip\"; \"Facing Potential Smartphone Weakness and Tough Competition, Qualcomm Stock's Outlook Is Not Particularly Strong\"; \"COMPUTEX 2026: Qualcomm declares \"Year of AI Agents\" with Snapdragon X2 Elite and Snapdragon C\".",
      "keyTakeaways": [
        {
          "text": "Qualcomm has been in discussions to acquire AI chip startup Tenstorrent in a transaction that could value the company between $8B and $10B, according to The ...",
          "articleIds": [
            "co-ti1"
          ],
          "subCategory": "nvidia"
        ...
        {
          "text": "Qualcomm acquired AI software startup Modular for $3.9B in an all-stock deal. The Mojo language and MAX inference engine aim to break NVIDIA's CUDA software ...",
          "articleIds": [
            "co3"
          ],
          "subCategory": "nvidia"
        ...
        {
          "text": "OpenAI partnered with Qualcomm and MediaTek to co-develop smartphone processors optimized for on-device AI. The project could redefine the high-end handset m...",
          "articleIds": [
            "co2"
          ],
        ...
        {
          "text": "At COMPUTEX 2026, Qualcomm CEO Cristiano Amon declared 2026 the \"Year of AI Agents.\" Unveiled Snapdragon C for budget AI PCs ($499+) and Snapdragon X2 Elite ...",
          "articleIds": [
            "co-qc1"
          ],
          "subCategory": "intel"
    ...
    "articles": [
      {
        "id": "co-ti1",
        "title": "Qualcomm in Talks to Buy Tenstorrent to Expand AI Chip Capabilities",
      ...
      {
        "id": "co-qc1",
        "title": "COMPUTEX 2026: Qualcomm declares \"Year of AI Agents\" with Snapdragon X2 Elite and Snapdragon C",
  ...
  "core-businesses": {
    ...
    "briefing": {
      ...
      "keyTakeaways": [
        ...
        {
          "text": "Qualcomm Dragonfly extends system-level leadership end-to-end, joining Snapdragon for consumer and Dragonwing for industrial solutions. The new brand unifies...",
          "articleIds": [
            "cb-qc2"
          ],
          "subCategory": "semiconductors"
        ...
        {
          "text": "Qualcomm unveiled the X105 5G Modem-RF at MWC 2026, the world's first Release 19-capable modem. Features agentic AI support, quad-frequency GNSS, and integra...",
          "articleIds": [
            "cb-fw1"
          ],
        ...
        {
          "text": "Qualcomm unveiled Dragonwing MBM range of broadband chips built around rich multimedia experiences, advanced connectivity and on-device AI. The family target...",
          "articleIds": [
            "cb3"
          ],
          "subCategory": "wireless"
        ...
        {
          "text": "Qualcomm unveiled its Wi-Fi 8 portfolio at MWC 2026, delivering a new connectivity foundation for AI-era performance across mobile devices, PCs, XR and netwo...",
          "articleIds": [
            "cb-qc1"
          ],
          "subCategory": "wireless"
        ...
        {
          "text": "Qualcomm reached $1.1B in automotive revenue with $45B in design-win pipeline. Snapdragon Digital Chassis enables AI-powered software-defined vehicles across...",
          "articleIds": [
            "cb4"
          ],
        ...
        {
          "text": "Qualcomm is set to release its fiscal Q3 earnings this month. The report will be closely watched for handset, automotive and IoT segment guidance amid memory...",
          "articleIds": [
            "cb-yf2"
          ],
          "subCategory": "market-performance"
        ...
        {
          "text": "Qualcomm reported mixed fiscal Q2 2026 results. Revenue slightly declined while net profit surged 162% due to one-time gains. Memory supply constraints weigh...",
          "articleIds": [
            "cb5"
          ],
          "subCategory": "semiconductors"
    ...
    "articles": [
      ...
      {
        "id": "cb-qc2",
        "title": "Introducing Qualcomm Dragonfly — Data Center Platform Unifies CPU, AI and Networking",
      ...
      {
        "id": "cb-fw1",
        "title": "MWC 2026: Qualcomm unveils X105 5G Modem with AI — all in prep for 6G",
      ...
      {
        "id": "cb-qc1",
        "title": "Qualcomm Debuts AI-Native Wi-Fi 8 Portfolio Unifying Client and Network Connectivity",
  ...
  "growth-areas": {
    ...
    "briefing": {
      "summary": "As of 2026-03-02, 6 article(s) from The Verge, TechCrunch, Mobile World Live, RCR Wireless News, Qualcomm Newsroom cover growth areas: \"Qualcomm's new Snapdragon Wear Elite chip is geared toward wearable AI gadgets\"; \"Qualcomm wants to be the chip inside whatever replaces your smartphone\"; \"Snap snaps up Snapdragon XR for eyewear push in multi-year deal\"; \"Qualcomm is taking a full-stack approach to edge AI\"; \"Qualcomm IE-IoT Expansion Is Complete: Edge AI Unleashed for Developers, Enterprises and OEMs\"; \"Qualcomm expects AI-boosting 6G devices in 2029\".",
      "keyTakeaways": [
        {
          "text": "Qualcomm announced Snapdragon Wear Elite, a \"wrist plus\" chip on 3nm process with integrated eNPU and Hexagon NPU handling 2B parameters on-device. Supports ...",
          "articleIds": [
            "ga-tv1"
          ],
        ...
        {
          "text": "Qualcomm CEO Cristiano Amon revealed 40+ AI wearable designs in development. Announced Snapdragon Reality Elite XR platform (60% GPU boost, 160% NPU boost) a...",
          "articleIds": [
            "ga1"
          ],
          "subCategory": "xr-spatial-computing"
        ...
        {
          "text": "Snap subsidiary Specs struck a multi-year agreement with Qualcomm to use Snapdragon XR platform in smart glasses. The deal positions Qualcomm as the primary ...",
          "articleIds": [
            "ga2"
          ],
          "subCategory": "xr-spatial-computing"
        ...
        {
          "text": "Qualcomm built a full-stack edge AI platform through acquisitions of Foundries.io (Linux IoT), Edge Impulse (AI/ML development with 170K+ developers), Advant...",
          "articleIds": [
            "ga-rcr1"
          ],
        ...
        {
          "text": "Qualcomm completed its acquisition of Augentix, a leader in mass-market image processors, extending its ability to provide SoCs for smart cameras and industr...",
          "articleIds": [
            "ga-qc3"
          ],
          "subCategory": "on-device-ai"
        ...
        {
          "text": "At MWC Shanghai 2026, Qualcomm SVP John Smee said pre-commercial 6G devices could arrive by 2028 with commercial shipments in 2029. Positioned 6G as the firs...",
          "articleIds": [
            "ga3"
          ],
          "subCategory": "on-device-ai"
    ...
    "articles": [
      {
        "id": "ga-tv1",
        "title": "Qualcomm's new Snapdragon Wear Elite chip is geared toward wearable AI gadgets",
      ...
      {
        "id": "ga-rcr1",
        "title": "Qualcomm is taking a full-stack approach to edge AI",
      ...
      {
        "id": "ga-qc3",
        "title": "Qualcomm IE-IoT Expansion Is Complete: Edge AI Unleashed for Developers, Enterprises and OEMs",
  ...
  "ip-legal": {
    ...
    "briefing": {
      "summary": "As of 2026-01-28, 8 article(s) from Light Reading, IEEE ComSoc, IP Fray, Mobile World Live cover ip & legal: \"Huawei and Qualcomm tussle for 5G patents lead as 6G draws closer\"; \"Huawei, Qualcomm, Samsung, and Ericsson lead patent race in $15 billion 5G licensing market\"; \"UPC Munich clears chipset makers Qualcomm and NVIDIA of infringement — appeals very likely\"; \"FedEx can fight another day in Qualcomm dispute as Federal Circuit considers IPR real-parties-in-interest\"; \"Détente in Munich: Onesta settling with Qualcomm, but keeping up pressure on BMW\"; \"Qualcomm settles $650M UK consumer class action from position of strength — no payment to consumers\"; \"Heated debate on preliminary injunctions and rate-setting at OxFora IP Forum — Qualcomm, Huawei, Amazon, Dell panel\"; \"Qualcomm inks $4B deal for AI software specialist Modular\".",
      "keyTakeaways": [
        {
          "text": "Huawei leads in total 5G patent declarations, but Qualcomm ranks #1 on LexisNexis Patent Asset Index measuring patent quality and value. The $15B annual 5G l...",
          "articleIds": [
            "ip-lr1"
          ],
          "subCategory": "sep"
        ...
        {
          "text": "LexisNexis 2026 report shows 5G patent licensing market at ~$15B annually. Qualcomm ranks #1 on Patent Asset Index measuring citation impact and internationa...",
          "articleIds": [
            "ip1"
          ],
          "subCategory": "sep"
        ...
        {
          "text": "The Unified Patent Court's Munich Local Division found no infringement in cases targeting Qualcomm and NVIDIA chipsets. The ruling is a significant win for c...",
          "articleIds": [
            "ip-if2"
          ],
        ...
        {
          "text": "The USPTO withdrew its initial defense of the PTAB's refusal to consider FedEx's arguments about real parties in interest in an inter partes review involving...",
          "articleIds": [
            "ip-if3"
          ],
          "subCategory": "patent-litigation"
        ...
        {
          "text": "A settlement between Qualcomm and Onesta over Munich patent lawsuits appears imminent. Onesta's patent infringement allegations relate to Qualcomm chips used...",
          "articleIds": [
            "ip-if4"
          ],
          "subCategory": "patent-litigation"
        ...
        {
          "text": "UK consumer group Which? withdrew its £480M class action against Qualcomm after a trial on the merits. The settlement involves no payment to consumers and in...",
          "articleIds": [
            "ip-if1"
          ],
        ...
        {
          "text": "At OxFora's 14th IP and Competition Forum, panelists from Qualcomm, Huawei, Amazon and Dell debated whether injunctions should exist in SEP disputes. Amazon ...",
          "articleIds": [
            "ip-if5"
          ],
        ...
        {
          "text": "Qualcomm acquired Modular for $3.9B in all-stock deal. The Mojo programming language and MAX engine allow AI models to run across CPUs, GPUs, NPUs without se...",
          "articleIds": [
            "ip2"
          ],
          "subCategory": "ip"
    ...
    "articles": [
      {
        "id": "ip-lr1",
        "title": "Huawei and Qualcomm tussle for 5G patents lead as 6G draws closer",
        ...
        "section": "ip-legal",
        "subCategory": "sep",
        "subLabel": "SEP / Standards Patents"
      },
      {
        "id": "ip1",
      ...
      {
        "id": "ip-if2",
        "title": "UPC Munich clears chipset makers Qualcomm and NVIDIA of infringement — appeals very likely",
      ...
      {
        "id": "ip-if3",
        "title": "FedEx can fight another day in Qualcomm dispute as Federal Circuit considers IPR real-parties-in-interest",
      ...
      {
        "id": "ip-if4",
        "title": "Détente in Munich: Onesta settling with Qualcomm, but keeping up pressure on BMW",
      ...
      {
        "id": "ip-if1",
        "title": "Qualcomm settles $650M UK consumer class action from position of strength — no payment to consumers",
        ...
        "section": "ip-legal",
        "subCategory": "regulatory-antitrust",
        "subLabel": "Regulatory & Antitrust"
      },
      {
        "id": "ip-if5",
        "title": "Heated debate on preliminary injunctions and rate-setting at OxFora IP Forum — Qualcomm, Huawei, Amazon, Dell panel",
  ...
  "macro-environment": {
    ...
    "briefing": {
      ...
      "keyTakeaways": [
        ...
        {
          "text": "Qualcomm's ByteDance custom chip talks highlight the complex geopolitics of semiconductor design. The deal leverages Alphawave Semi technology (acquired June...",
          "articleIds": [
            "me2"
          ],
        ...
        {
          "text": "Qualcomm disclosed that Microsoft and Meta will adopt its newly launched AI chips, while two additional hyperscale customers have signed on. The company is d...",
          "articleIds": [
            "me-re1"
          ],
          "subCategory": "geopolitics-export-controls"
        ...
        {
          "text": "At CES 2026, Qualcomm expanded automotive collaborations with Google, Toyota, Li Auto, NIO, Leapmotor, ZF, and Stellantis. Snapdragon Ride Flex — first mixed...",
          "articleIds": [
            "me3"
          ],
  ...
  "stakeholders": {
    ...
    "briefing": {
      "summary": "As of 2026-06-16, 4 article(s) from IEEE ComSoc, Mobile World Live, Fierce Wireless, Qualcomm Newsroom cover key stakeholders: \"3GPP approves timelines for Release 21: 6G specs set for early 2029\"; \"Qualcomm expects AI-boosting 6G devices in 2029, positioning 6G as AI-native\"; \"Q&A: 6G is coming — Qualcomm's John Smee on AI, connectivity and the future of everything\"; \"Qualcomm accelerates 6G with AI-native device-to-data-center transformation\".",
      "keyTakeaways": [
        {
          "text": "3GPP TSG RAN #112 in Singapore approved Release 21 timeline. First 6G specs functional freeze March 2027, final freeze December 2028, code freeze March 2029....",
          "articleIds": [
            "st1"
          ],
          "subCategory": "3gpp"
        ...
        {
          "text": "At MWC Shanghai 2026, Qualcomm SVP John Smee framed 6G as the wireless technology for the age of AI. \"AI is the new UI\" — context-aware agents delivered thro...",
          "articleIds": [
            "st3"
          ],
          "subCategory": "3gpp"
        ...
        {
          "text": "Qualcomm SVP John Smee outlines 6G strategy: AI-native networks, predictive analytics, integrated sensing. 6G to deliver QoS that Wi-Fi cannot match. WRC-27 ...",
          "articleIds": [
            "st2"
          ],
          "subCategory": "etsi"
        ...
        {
          "text": "Qualcomm is advancing 6G with AI-native platforms that unify connectivity, sensing and compute from devices to the data center. The transformation extends be...",
          "articleIds": [
            "st-qc1"
          ],
          "subCategory": "3gpp"
    ...
    "articles": [
      ...
      {
        "id": "st2",
        "title": "Q&A: 6G is coming — Qualcomm's John Smee on AI, connectivity and the future of everything",
      ...
      {
        "id": "st-qc1",
        "title": "Qualcomm accelerates 6G with AI-native device-to-data-center transformation",
